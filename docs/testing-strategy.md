...
| E2E | Playwright (Chromium) | Homepage (4), brand pages (16), franchise form (5), navigation (4), accessibility (6), axe audits (5), agent page + privacy guard (18) |
...
**Totals:** 71 unit/component tests + 58 E2E tests = **129 tests**
...
| `agent-privacy.spec.ts` | 18 | `/agent` (ES/EN) renders with no forms/inputs, `/llms.txt` is plain text, `robots.txt` allows AI crawlers; **privacy guard**: every public page + llms/robots/sitemap must not contain denylisted internal/stack tokens |
...
| **Test** | `npm run test` | 71 unit/component tests |
| **Build** | `npm run build` | Next.js production build |
| **E2E** | `npx playwright test` | 58 tests against built app, depends on build |
